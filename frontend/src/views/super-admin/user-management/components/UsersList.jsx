    ...
    return (
        <div className="p-4 md:p-8">
            <div className="mb-8">
                ...
                <p className="text-gray-600">Lihat dan kelola semua pengguna dalam sistem</p>
            </div>

            <div className="bg-white rounded-xl shadow-md p-6">
                <div className="flex items-center justify-center h-40 flex-col">
                    <MdPeople className="h-16 w-16 text-blue-500 mb-4" />
                    <h2 className="text-xl text-gray-600">Daftar pengguna sedang dalam pengembangan</h2>
                </div>
            </div>
        </div>
    );
