        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    {/* Quick Analytics */}
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-200 rounded-xl p-6" data-aos="fade-up" data-aos-delay="600">
                        <h3 className="text-lg font-semibold text-purple-800 mb-4">Analisis Cepat</h3>
                        <div className="space-y-3 text-sm">
                            <div className="flex items-center justify-between">
                                <span className="text-purple-700">Tingkat Kehadiran</span>
                                <span className="font-bold text-purple-800">
                                    {classDetail.accessLogs && classDetail.enrolled_students > 0 
                                        ? Math.round((classDetail.accessLogs.length / classDetail.enrolled_students) * 100) 
                                        : 0}%
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-purple-700">Mahasiswa Aktif</span>
                                <span className="font-bold text-purple-800">
                                    {classDetail.accessLogs ? new Set(classDetail.accessLogs.map(log => log.studentId)).size : 0}
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-purple-700">Rata-rata per Hari</span>
                                <span className="font-bold text-purple-800">
                                    {classDetail.accessLogs 
                                        ? Math.round(classDetail.accessLogs.length / 7) 
                                        : 0} akses
                                </span>
                            </div>
                        </div>
